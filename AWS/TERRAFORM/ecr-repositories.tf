...
# Outputs
output "ecr_mkpublisher_repository_url" {
  description = "URL of the MKPublisher ECR repository"
  value       = aws_ecr_repository.mk_services["mkpublisher"].repository_url
}

output "ecr_mkconsumer_repository_url" {
  description = "URL of the MKConsumer ECR repository"
  value       = aws_ecr_repository.mk_services["mkconsumer"].repository_url
}
...
output "ecr_registry_id" {
  ...
  value       = aws_ecr_repository.mk_services["mkpublisher"].registry_id
}
